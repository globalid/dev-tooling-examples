      ...
      input_descriptors: [
        {
          ...
          schema: {
            oneof_filter: [
              {
                required: true,
                uri: 'https://credentials.globalid.dev/v1/schema-registry/contexts/Driving%20license/versions/2#Driving%20license'
              },
              {
                required: true,
                uri: 'https://credentials.globalid.dev/v1/schema-registry/contexts/Passport/versions/2#Passport'
              }
            ]
          },
          constraints: {
